...
There is no need for frontend files because the display is simple enough to [set our frontend properties in the Perl](http://docs.duckduckhack.com/frontend-reference/setting-goodie-display.html).
