...
For detailed instructions on how to create a Cheat Sheet, follow any of the [Cheat Sheet Walkthroughs](https://talsraviv.gitbooks.io/duckduckhackdocs/content/duckduckhack/walkthroughs/programming-syntax.html).
