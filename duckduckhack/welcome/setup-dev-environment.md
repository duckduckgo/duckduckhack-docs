...
6. To start working on a new change, create a new branch in your repository for this particular project. Make sure to work on [a separate branch](https://talsraviv.gitbooks.io/duckduckhackdocs/content/duckduckhack/resources/git-workflow.html) for each contribution. 
